...
INSERT IGNORE INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`) VALUES
('imaging_report_services', 'guardia',         'Emergency Room / Urgency',   1, 1, 0, '', 'Emergency and Urgency Service', ''),
('imaging_report_services', 'clinica_medica',  'Internal Medicine',          2, 0, 0, '', 'Inpatient and Outpatient Internal Medicine', ''),
('imaging_report_services', 'traumatologia',   'Traumatology / Orthopedics', 3, 0, 0, '', 'Orthopedics and Traumatology', ''),
('imaging_report_services', 'pediatria',       'Pediatrics',                 4, 0, 0, '', 'Pediatric Care', ''),
('imaging_report_services', 'uti',             'Intensive Care Unit (ICU)',  5, 0, 0, '', 'Intensive Care', ''),
('imaging_report_services', 'cirugia',         'General Surgery',            6, 0, 0, '', 'Surgical Service', ''),
('imaging_report_services', 'consultorio_ext', 'Outpatient Clinic',          7, 0, 0, '', 'Ambulatory / Specialties', '');

-- 3. Options for the Anatomical Regions list ('imaging_report_anatomy')
INSERT IGNORE INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`) VALUES
-- Head, Neck and Facial Mass
('imaging_report_anatomy', 'craneo_cerebro',     'Skull / Brain',                10, 0, 0, '', 'Skull, brain and cerebral parenchyma', 'SNOMED-CT:12738000'),
('imaging_report_anatomy', 'macizo_facial',      'Facial Mass / Paranasal Sinuses', 11, 0, 0, '', 'Paranasal sinuses and facial bones', 'SNOMED-CT:1101003'),
('imaging_report_anatomy', 'orbita_silla_turca', 'Orbits / Sella Turcica',       12, 0, 0, '', 'Orbits, petrous bones and pituitary fossa', 'SNOMED-CT:361038002'),
('imaging_report_anatomy', 'cuello_partes_blandas', 'Neck / Soft Tissues',      13, 0, 0, '', 'Soft tissues of the neck, thyroid and nasopharynx', 'SNOMED-CT:45048000'),
-- Spine
('imaging_report_anatomy', 'columna_cervical',   'Cervical Spine',               20, 0, 0, '', 'Cervical Spine', 'SNOMED-CT:122494005'),
('imaging_report_anatomy', 'columna_dorsal',     'Dorsal / Thoracic Spine',      21, 0, 0, '', 'Thoracic Spine', 'SNOMED-CT:122495006'),
('imaging_report_anatomy', 'columna_lumbar',     'Lumbar Spine',                 22, 1, 0, '', 'Lumbosacral Spine', 'SNOMED-CT:122496007'),
('imaging_report_anatomy', 'sacro_coxis',        'Sacrum / Coccyx',              23, 0, 0, '', 'Sacrum and Coccyx', 'SNOMED-CT:87031002'),
-- Thorax, Abdomen and Pelvis
('imaging_report_anatomy', 'torax',              'Thorax',                       30, 0, 0, '', 'Thorax, lungs and mediastinum', 'SNOMED-CT:51185008'),
('imaging_report_anatomy', 'mamografia_mama',    'Breast (Left / Right / Bilateral)', 31, 0, 0, '', 'Breast gland and axilla', 'SNOMED-CT:76752008'),
('imaging_report_anatomy', 'abdomen_superior',   'Upper Abdomen',                32, 0, 0, '', 'Liver, biliary tract, pancreas and spleen', 'SNOMED-CT:818983003'),
...
('imaging_report_anatomy', 'pelvis_ginecologica','Pelvis / Genital System',      34, 0, 0, '', 'Female/male pelvis and bladder', 'SNOMED-CT:12921003'),
-- Upper Limb
('imaging_report_anatomy', 'hombro',             'Shoulder',                     40, 0, 0, '', 'Scapulohumeral joint and clavicle', 'SNOMED-CT:16982005'),
('imaging_report_anatomy', 'brazo_humero',       'Arm / Humerus',                41, 0, 0, '', 'Humeral shaft', 'SNOMED-CT:40983000'),
('imaging_report_anatomy', 'codo',               'Elbow',                        42, 0, 0, '', 'Elbow joint', 'SNOMED-CT:127949000'),
('imaging_report_anatomy', 'antebrazo',          'Forearm (Radius and Ulna)',    43, 0, 0, '', 'Radius and ulna', 'SNOMED-CT:64262003'),
('imaging_report_anatomy', 'muneca_mano',        'Wrist / Hand',                 44, 0, 0, '', 'Carpus, metacarpals and phalanges', 'SNOMED-CT:85050009'),
-- Lower Limb
('imaging_report_anatomy', 'cadera_pelvis',      'Hip / Bony Pelvis',            50, 0, 0, '', 'Pelvic girdle and coxofemoral joint', 'SNOMED-CT:29836001'),
('imaging_report_anatomy', 'muslo_femur',        'Thigh / Femur',                51, 0, 0, '', 'Femoral shaft', 'SNOMED-CT:29838000'),
('imaging_report_anatomy', 'rodilla',            'Knee',                         52, 0, 0, '', 'Femorotibial joint and patella', 'SNOMED-CT:72696002'),
('imaging_report_anatomy', 'pierna_tibia_perone','Leg (Tibia and Fibula)',       53, 0, 0, '', 'Tibia and fibula', 'SNOMED-CT:30254006'),
('imaging_report_anatomy', 'tobillo_pie',        'Ankle / Foot',                 54, 0, 0, '', 'Tarsals, metatarsals and phalanges', 'SNOMED-CT:56459004');
